      ...
      dashboardBody(
             tabItems(
                 ...
                 tabItem(tabName="get-data",
                         useShinyjs(),
                         h1("Analyze somatic mutation data from MAF files"),
                         actionLink("about_info","More info"),
                         bsModal("about_info_popup","MAFWiz","about_info",
                                 # hr(),
                                 includeMarkdown("html_content/about.md"),
                                 size="large"),
                         tags$hr(),
                         h3("Apply filters"),
                          # tags$hr(),
